...
class AmountBasePolicyTest {
    ...
    void testApplyDiscountSuccessfully() {
        ...
        when(discountLevelService.getDiscountPolicyLevels(Policy.AMOUNT_BASED)).thenReturn(discountLevels);
        //when
        var priceAfterDiscount = new AmountBasePolicy(productCount, discountLevelService).calculateDiscount(inputPrice);
        //then
    ...
    void testWrongDenominations() {
        ...
        try {
            //when
            new AmountBasePolicy(productCount, discountLevelService).calculateDiscount(inputPrice);
