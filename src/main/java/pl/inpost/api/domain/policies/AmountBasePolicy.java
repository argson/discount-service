...
class AmountBasePolicy extends AbstractDiscountPolicy {


    public AmountBasePolicy(@NonNull Long productCount,
                            @NonNull DiscountPolicyServiceInterface discountLevelService) {
